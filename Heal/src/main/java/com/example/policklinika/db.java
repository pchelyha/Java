...
public class db {
    ...
    private final String LOGIN = env.getOrDefault("DB_USER","user19") ; // Если OpenServer, то здесь mysql напишите
    private final String PASS = env.getOrDefault("DB_PASS","ilya"); // Если OpenServer, то здесь mysql напишите
